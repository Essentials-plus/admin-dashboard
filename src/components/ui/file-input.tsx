...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          `w-full rounded-lg duration-300 ease-in-out flex flex-col justify-center items-center text-center py-5 border border-dashed border-border`,
          className,
