...
import {
  CreateOrUpdateHomePageHeroSectionFormProps,
  createOrUpdateHomePageHeroSectionSchema,
  CreateOrUpdateHomePageHeroSectionSchema,
} from '@/views/home-page/components/create-or-update-home-page-hero-section-form/schema';
...
const identifier = 'home-page.hero-section';

const CreateOrUpdateHomePageHeroSectionForm =
  ({}: CreateOrUpdateHomePageHeroSectionFormProps) => {
    ...
    const initialValues: Optionalize<CreateOrUpdateHomePageHeroSectionSchema> =
      rawDataData &&
...
export default CreateOrUpdateHomePageHeroSectionForm;
