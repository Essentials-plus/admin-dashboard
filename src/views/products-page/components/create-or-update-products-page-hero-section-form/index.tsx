...
import {
  CreateOrUpdateProductsPageHeroSectionFormProps,
  createOrUpdateProductsPageHeroSectionSchema,
  CreateOrUpdateProductsPageHeroSectionSchema,
} from '@/views/products-page/components/create-or-update-products-page-hero-section-form/schema';
...
const identifier = 'products-page.hero-section';

const CreateOrUpdateProductsPageHeroSectionForm =
  ({}: CreateOrUpdateProductsPageHeroSectionFormProps) => {
    ...
    const initialValues: Optionalize<CreateOrUpdateProductsPageHeroSectionSchema> =
      rawDataData &&
...
export default CreateOrUpdateProductsPageHeroSectionForm;
